...
def add_vars_to_csv(fname, d):
    ...
    columns = ['Patm', 'u', 'CO2', 'O2', 'Vmax25', 'gamstar25', 'Tref', 'JV',
               ...
               'height', 'LAI', 'max_leaf_width', 'g1', 'g1T', 'beta', 'Lambda',
               'BoA', 'P50', 'P88', 'kmax', 'kmaxT', 'kmaxWUE', 'kmaxCN',
               'kmaxCM', 'kmaxLC', 'kmaxS1', 'kmaxS2', 'ksc_prev', 'krlC',
               'krlM', 'ratiocrit', 'ksrmaxC', 'ksrmaxM', 'sref', 'srefT',
               'PrefT', 'PcritC', 'PcritM', 'Alpha', 'Beta', 'ground_area',
               'Ztop', 'Zbottom', 'Ps', 'Psie', 'hyds', 'theta_sat', 'fc',
               'pwp', 'bch']
    ...
    try:
        df2 = pd.DataFrame([(d.Patm, d.u, d.CO2, d.O2, d.Vmax25, d.gamstar25,
                             ...
                             d.g1, d.g1T, d.beta, d.Lambda, d.BoA, d.P50, d.P88,
                             d.kmax, d.kmaxT, d.kmaxWUE, d.kmaxCN, d.kmaxCM,
                             d.kmaxLC, d.kmaxS1, d.kmaxS2, d.ksc_prev, d.krlC,
                             d.krlM, d.ratiocrit, d.ksrmaxC, d.ksrmaxM, d.sref,
                             d.srefT, d.PrefT, d.PcritC, d.PcritM, d.Alpha,
                             d.Beta, d.ground_area, d.Ztop, d.Zbottom, d.Ps,
                             d.Psie, d.hyds, d.theta_sat, d.fc, d.pwp,
        ...
        df2 = pd.DataFrame([(d2.Patm, d2.u, d2.CO2, d2.O2, d2.Vmax25,
                             ...
                             d2.LAI, d2.max_leaf_width, d2.g1, d2.g1T, d2.beta,
                             d2.Lambda, d2.BoA, d2.P50, d2.P88, d2.kmax,
                             d2.kmaxT, d2.kmaxWUE, d2.kmaxCN, d2.kmaxCM,
                             d2.kmaxLC, d2.kmaxS1, d2.kmaxS2, d2.ksc_prev,
                             d2.krlC, d2.krlM, d2.ratiocrit, d2.ksrmaxC,
                             d2.ksrmaxM, d2.sref, d2.srefT, d2.PrefT,
                             d2.PcritC, d2.PcritM, d2.Alpha, d2.Beta,
                             d2.ground_area, d2.Ztop, d2.Zbottom, d2.Ps,
                             d2.Psie, d2.hyds, d2.theta_sat, d2.fc, d2.pwp,
                             d2.bch)], columns=columns)
