try:
    ...
    from coupler_utils import dAdgs, A_trans
    ...
    from ProfitMax2 import profit_E
    ...
    from TractLSM.CH2OCoupler.coupler_utils import dAdgs, A_trans
    ...
    from TractLSM.CH2OCoupler.ProfitMax2 import profit_E
