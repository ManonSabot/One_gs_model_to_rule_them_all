...
from TractLSM.CH2OCoupler import CAP  #
from TractLSM.CH2OCoupler import MES  #
...
def run(fname, df, Nsteps, photo, models=['Medlyn', 'ProfitMax'],
    ...
    df2: pandas dataframe
        dataframe of the outputs:
            A_std, E_std, Ci_std, Rublim_std, gs_std, Pleaf_std, Ps_std
    ...
    # specific SOX cases (i.e. SOX empirical and SOX optimal)?
    Scases = find_model_cases(models, 'SOX')

    # if cases aren't specified, then set to the default (empirical) SOX case
