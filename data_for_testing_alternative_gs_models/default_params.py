...
class default_params(object):  # default inputs needed to run model
    ...
    def __init__(self):
        ...
        self.kmaxT = self.kmax  # max plant hydr cond / LAI in Tuzet
        self.kmaxS1 = self.kmax * 0.4  # kmax from SOX analytical
        self.kmaxLC = self.kmax  # max plant hydr cond / LAI in Least Cost
        ...
        self.hyds = 9.305051e-6  # saturation hydraulic conductivity (m s-1)
        self.fc = 0.213388  # field capacity (m3 m-3)
        self.theta_sat = 0.4079013  # soil moisture at saturation (m3 m-3)
