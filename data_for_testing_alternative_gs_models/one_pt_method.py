...
class FarquharC3(object):
    ...
    * Medlyn, B. E., Dreyer, E., Ellsworth, D., Forstreuter, M., Harley, P.C.,
    ...
    def __init__(self, peaked_Jmax=False, peaked_Vcmax=False, Oi=210.756,
                 gamstar25=42.75915, Kc25=404.8947, Ko25=278.4411, Ec=79430.0,
                 Eo=36380.0, Eag=37830.0, theta_hyperbol=0.99,
...
def est_one_point_vcmax(F, Photo, Ci, Tleaf, Pressure=None, Rd=None):
    ...
    # Assuming B&C took measurements at Carnegie Institution of Washington
    # which is roughly at an elevation of 70m, so assuming a standrd pressure
    ...
    if Pressure is not None:
        ...
        if Ko25_1 is not None:
            # Bernacchi / Crous
            Ko25 *= mmol_2_mole * illinois_pressure * pascal_to_ubar

        # mbar
        if Kc25 is not None:
            # Bernacchi / Crous
            Kc25 *= illinois_pressure * pascal_to_mbar



    Kc = F.arrh(Kc25, 79430.0, Tleaf)
    Ko = F.arrh(Ko25, 36380.0, Tleaf)
    gamma_star = F.arrh(42.75915, 37830.0, Tleaf)
